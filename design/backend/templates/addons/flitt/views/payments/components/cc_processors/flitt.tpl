...
{assign var="currency" value=fn_get_currencies()}
{assign var="language" value=$smarty.const.LANGUAGE|fn_get_simple_languages}

<div class="control-group">
    <label class="control-label" for="test_mode">{__("flitt.test_mode")}:</label>
    <div class="controls">
...
<div class="control-group">
    <label class="control-label" for="merchant_id">{__("flitt.merchant_id")}:</label>
    <div class="controls">
...
<div class="control-group">
    <label class="control-label" for="password">{__("flitt.password")}:</label>
    <div class="controls">
...
<div class="control-group">
    <label class="control-label" for="language">{__("flitt.language")}</label>
    <div class="controls">
...
<div class="control-group" id="row_status_hold">
    <label class="control-label" for="status_hold">{__("flitt.status_hold")}</label>
    <div class="controls">
...
<div class="control-group" id="row_paid_order_status">
    <label class="control-label" for="paid_order_status">{__("flitt.paid_order_status")}</label>
    <div class="controls">
...
<div class="control-group">
    <label class="control-label" for="currency">{__("flitt.currency")}:</label>
    <div class="controls">
